...
public class Main {
	...
	// URL
	// 1. Uniform Resource Locator : 정형화
	...
	public static void m4() {
		...
		try {
			...
			// %EC%9E%90%EB%B0%94+JAVA+%21%40%23%24

			String encodedStr2 = URLEncoder.encode(str2, StandardCharsets.UTF_8);
			// %EC%9E%90%EB%B0%94%2BJAVA%2B%21%40%23%24
			
			System.out.println(encodedStr1);
			System.out.println(encodedStr2);
			
			// 디코딩
			String decodedStr1 = URLDecoder.decode(str1, "UTF-8");
			// decodedStr1 = "자바 JAVA !@#$"
			
			String decodedStr2 = URLDecoder.decode(str2, StandardCharsets.UTF_8);
			// decodedStr2 = "자바+JAVA+!@#$"
