...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductDTO> list1() {
		...
		ProductDTO product1 = new ProductDTO(1111L, "포카칩", "오리온", 1500);
		ProductDTO product3 = new ProductDTO(2222L, "미쯔", "오리온", 700);
		ProductDTO product2 = new ProductDTO(3333L, "뺴빼로", "오리온", 1200);
