...
public class Controller2 {
	...
	public ModelAndView add2(String title, Long hit) {    // @RequestParam 애너테이션을 생략했다.
	...
	public ModelAndView add3(Board board) {    // Board 클래스의 setTitle, setHit가 동작하면서 파라미터를 받아 줍니다.
