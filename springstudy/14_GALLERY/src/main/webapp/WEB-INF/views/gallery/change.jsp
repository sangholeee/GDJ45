...
<body>
	...
	<form id="f" action="${contextPath}/gallery/change" method="post" enctype="multipart/form-data">
		...
		내용 <input type="text" name="content" id="content" value="${gallery.content}"><br><br>
	...
	<c:forEach var="fileAttach" items="${fileAttaches}">
		<div>${fileAttach.origin}<a href="${contextPath}/gallery/removeFileAttach?fileAttachNo=${fileAttach.fileAttachNo}&galleryNo=${fileAttach.galleryNo}"><i class="fa-solid fa-square-xmark"></i></a></div>
	</c:forEach>
