...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("부대명 : " + soldier1.getArmy().get("부대명"));
		System.out.println("부대위치 : " + soldier1.getArmy().get("부대위치"));
		System.out.println();
		...
		System.out.println("부대명 : " + soldier2.getArmy().get("부대명"));
		System.out.println("부대위치 : " + soldier2.getArmy().get("부대위치"));
