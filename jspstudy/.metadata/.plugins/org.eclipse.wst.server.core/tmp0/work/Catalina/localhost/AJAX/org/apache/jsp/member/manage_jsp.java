 ...
 * Generated at: 2022-05-03 05:14:08 UTC
...
public final class manage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("						$('#no').val(responseText.member.no);\r\n");
      ...
      out.write("				data: $('#formMember').serialize(),    // 폼의 모든 요소를 줄줄이 &로 연결해서 보낸다.\r\n");
      out.write("				// 여기까지 요청\r\n");
      ...
      out.write("			$.ajax({\r\n");
      out.write("				url: '/AJAX/modify.do',\r\n");
      out.write("				data: $('#formMember').serialize(),\r\n");
      out.write("				type: 'post',\r\n");
      out.write("				dataType: 'json',\r\n");
      out.write("				success: function(responseText){\r\n");
      out.write("					if(responseText.res > 0) {\r\n");
      out.write("						alert('회원 정보가 수정되었습니다.');\r\n");
      out.write("						fnList();\r\n");
      out.write("					} else {\r\n");
      out.write("						alert('회원 정보 수정이 실패했습니다.');\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("			})\r\n");
      out.write("		})\r\n");
      ...
      out.write("						$('#address').val('');\r\n");
      out.write("					} else {\r\n");
      out.write("						alert('회원 정보 삭제가 실패했습니다.');\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("			})\r\n");
      out.write("		})\r\n");
