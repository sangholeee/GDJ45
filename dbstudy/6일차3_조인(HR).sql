...
SELECT E.EMPLOYEE_ID, E.LAST_NAME, E.JOB_ID        -- JOB_ID는 JOB_HISTORY와 EMPLOYEES 아무거나 사용 가능
  FROM EMPLOYEES E INNER JOIN JOB_HISTORY JH
    ON E.EMPLOYEE_ID = JH.EMPLOYEE_ID
 WHERE E.JOB_ID = JH.JOB_ID;     -- 일반조건
...
SELECT
  ...
  WHERE M.HIRE_DATE > E.HIRE_DATE;   -- HIRE_DATE는 DATE타입이므로 직접 비교한다.
...
SELECT
  ...
  WHERE YOU.SALARY > ME.SALARY
    AND YOU.HIRE_DATE > ME.HIRE_DATE;
