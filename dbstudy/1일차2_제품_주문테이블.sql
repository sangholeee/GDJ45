/*
    ...
    4) PRIMARY KEY : 기본키 (개체무결성 제약조건)  -> NOT NULL + UNIQUE
...
CREATE TABLE PRODUCT(
    PRODUCT_NO   NUMBER PRIMARY KEY,    --대소문자 입력 상관 없다. DB에 저장될 때에는 대문자로 저장됨.
